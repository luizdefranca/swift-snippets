...
###### Local Notification
```swift
LocalNotification.shared.register(
            title: "Hi local notification",
            subtitle: "this notification generated by farid tajer 😅",
            body: "hola holaaaaaaaaa laaaa lllaaaaaaaaaaaaaaaa hola holaaaaaaaaa laaaa lllaaaaaaaaaaaaaaaa",
            at: Date().addedBy(seconds: 20),
            categoryIdentifier: "kubakInboxMessage",
            sound: .default,
            attachment: .video,
            url: "https://hw4.cdn.asset.aparat.com/aparat-video/0384cb020850a07ab4f40de710b8e06d11896613-360p__17492.mp4")
```
